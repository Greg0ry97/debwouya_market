...
import 'package:debwouya_market/screens/user_side_screens/setting/setting_screen.dart';
...
class UserProfileController extends ChangeNotifier {
  ...
  clickOnSettings({required BuildContext context}) {
    NavigationMethods.pushMethod(
        context: context, widget: const UserSettingScreen());
  }
