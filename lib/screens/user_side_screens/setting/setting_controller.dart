...
import 'package:debwouya_market/screens/user_side_screens/faq/faq_screen.dart';
import 'package:debwouya_market/screens/user_side_screens/shipping_address/shipping_address_screen.dart';
import 'package:debwouya_market/screens/user_side_screens/user_notification/user_notification_screen.dart';
...
class UserSettingController extends ChangeNotifier {
  ...
  clickOnShippingAddress({required BuildContext context}) {
    NavigationMethods.pushMethod(
        context: context, widget: const ShippingAddressScreen());
  }
  clickOnNotificationAddress({required BuildContext context}) {
    NavigationMethods.pushMethod(
        context: context, widget: const UserNotificationScreen());
  }

  clickOnFaq({required BuildContext context}) {
    NavigationMethods.pushMethod(
        context: context, widget: const FaqScreen());
  }
}
